...
def rate_is_inconsistent(rate):
    valeur_min = rate["rate_open"] / 10
    valeur_max = rate["rate_open"] * 10


    if rate["rate_close"] < valeur_min and rate["rate_close"]> valeur_max:
        return True
    if rate["rate_open"] < valeur_min and rate["rate_open"] > valeur_max:
        return True
    if rate["rate_high"] < valeur_min and rate["rate_high"] > valeur_max:
        return True
    if rate["rate_low"] < valeur_min and rate["rate_low"] > valeur_max:
        return True
    return False
